        ...
        <tr>
            ...
            <td>
                <div style="font-weight: 400; line-height: 140%; text-align: left; word-wrap: break-word;line-height: 140%; color: #666666">
                    ...
                    <p style="font-size: 18px">Down@VolvoCars has detected that the system ${data.name} has been consistently marked as <span style="color: red;">down</span> for over ${getDownTimeString(data.timePassedFromDown)}.</p>
                    ...
                    ${data.isSubscription ? `<p style="font-size: 15px;margin: 2rem 0 0 0;">If you no longer wish to receive updates from this system <a href='https://down.volvocars.net/unsubscribe?system=${data.name || ''}&sId=${data._id || ''}&subId=${data.subId || ''}&subEmail=${data.email || ''}'>unsubscribe here</a>.</p>`
                    : ''}
